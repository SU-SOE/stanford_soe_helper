...
function spotlight() {
    ...
    // Add the listeners
    document.getElementById("edit-field-s-ppl-spot-affiliation-tid").addEventListener("click", spotlightTransition);
    document.getElementById("edit-field-s-ppl-spot-department-tid").addEventListener("click", spotlightTransition);
